      ...
      <div class="container">
         <div class="row">
            <div class="col-md-12 text-center mb-1 site-animate">
               <h2 class="display-4">Unser Menü</h2>
            ...
            <div class="col-md-12 text-center">
               <ul class="nav site-tab-nav nav-pills mb-2" id="pills-tab" role="tablist">
                  <!--
					 <li class="nav-item site-animate">
                        <a class="nav-link" id="pills-lunch-tab" data-toggle="pill" href="#pills-lunch" role="tab" aria-controls="pills-lunch" aria-selected="true">Mittag</a>
                     </li>
					   
                     <li class="nav-item site-animate">
                        <a class="nav-link active" id="pills-dinner-tab" data-toggle="pill" href="#pills-dinner" role="tab" aria-controls="pills-dinner" aria-selected="false">Gerichte</a>
                     </li>
                 
                      
                     <li class="nav-item site-animate">
                        <a class="nav-link" id="pills-drinks-tab" data-toggle="pill" href="#pills-drinks" role="tab" aria-controls="pills-drinks" aria-selected="false">Getränke</a>
                     </li>
                   -->
               </ul>
               <div class="tab-content text-left" id="menu_html">
                  <?php
                  include 'db/populate_menu_items.php';
                  ?>
                  <?php
                  include 'db/populate_allergens_and_additives.php';
                  ?>
               </div>
            </div>
         </div>
